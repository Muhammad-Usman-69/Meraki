    ...
    <header class="h-20">
        <nav class="flex z-10 fixed shadow-sm shadow-black w-full justify-between items-center bg-gray-700">
            ...
            <div class="mx-6 flex space-x-5">
                ...
                ?>
                <div>
                    <button onclick="menu()" type="button" class="relative w-10 h-10">
                        <?php
                        if (isset($_SESSION["log"]) && $_SESSION["log"] == true) {
                            echo '<img class="rounded-full menu-img w-10 transition-all duration-300 absolute top-0 left-0"
                        src="' . $profile_img . '">';
                        } else {
                            echo '<img class="menu-img w-10 transition-all duration-300 absolute top-0 left-0 invert"
                        src="images/menu.png">';
                        }
                        ?>
