<tr class="bg-gray-800 border-gray-700 text-white border-b hidden tr" id="#6969">
    ...
    <td class="py-4 grid grid-cols-1 gap-1 sm:flex">
        <div class="w-fit">
            ...
            <button data-modal-target="dummy-input-edit-modal" data-modal-toggle="dummy-input-edit-modal" href=""
...
<div id="dummy-input-detail-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative shadow bg-gray-700 border border-white rounded-md">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="dummy-input-detail-modal">
                ...
                <div class="space-y-4">
                    <div>
                        <label for="work-id-1" class="block mb-2 text-sm font-medium text-white">Your
                            Work Id</label>
                        <input type="text" id="work-id-1" name="work-id-1" value="#1"
                    ...
                    <div>
                        <label for="work-title-1" class="block mb-2 text-sm font-medium text-white">Your
                            Work
                            Title</label>
                        <input type="text" id="work-title-1" name="work-title-1" value="Login to Meraki! A To Do List."
...
<div id="dummy-input-edit-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
    class="hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative shadow bg-gray-700 border border-white rounded-md">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-600">
                ...
                <button type="button"
                    class="end-2.5 text-gray-400 bg-transparent rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center hover:bg-gray-600 hover:text-white"
                    data-modal-hide="dummy-input-edit-modal">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
            ...
            <form action="/?error=Can't update this" method="post">
                <div class="p-4 md:p-5 space-y-4">
                    <div>
                        <label for="work-edit-id-1" class="block mb-2 text-sm font-medium text-white">Your
                            Work Id</label>
                        <input type="text" id="work-edit-id-1" name="work-edit-id-1" value="#1"
                            class="border text-sm rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white"
                            readonly>
                    </div>
                    <div>
                        <label for="work-edit-title-1" class="block mb-2 text-sm font-medium text-white">Your
                            Work Title</label>
                    ...
                    <div>
                        <label for="work-edit-desc-1" class="block mb-2 text-sm font-medium text-white">Your
                            Work Description</label>
                        <textarea id="work-edit-desc-1" name="work-edit-desc-1" rows="4"
                            class="border text-sm rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white hide-scrollbar resize-none">1) Go to form. &#013;2) Put info about your work. &#013;3) Add the list.</textarea>
                    </div>
                    <div>
                        <label for="work-edit-time-1" class="block mb-2 text-sm font-medium text-white">Your
                            Work Time</label>
...
<div id="dummy-input-finish-modal" data-modal-backdrop="static" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative rounded-lg shadow bg-gray-700 border border-white">
            <button type="button"
                ...
                data-modal-hide="dummy-input-finish-modal">
                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 14 14">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <button onclick="window.open(`/?error=Can't finish this`, `_self`)"
                    data-modal-hide="dummy-input-finish-modal" type="button"
                ...
                <button data-modal-hide="dummy-input-finish-modal" type="button"
...
<div id="dummy-input-delete-modal" data-modal-backdrop="static" tabindex="-1"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative rounded-lg shadow bg-gray-700 border border-white">
            <button type="button"
                class="absolute top-3 end-2.5 text-gray-400 bg-transparent rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center hover:bg-gray-600 hover:text-white"
                data-modal-hide="dummy-input-delete-modal">
                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 14 14">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <button data-modal-hide="dummy-input-delete-modal" type="button"
                    class="focus:ring-4 focus:outline-none rounded-lg border text-sm font-medium px-5 py-2.5 focus:z-10 bg-gray-700 text-gray-300 border-gray-500 hover:text-white hover:bg-gray-600 focus:ring-gray-600">No,
                    cancel</button>
            </div>
        </div>
